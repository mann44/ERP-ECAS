...
font-size: 20px;
                ...
                <div class="row-fluid">
                        ...
                        <h1><img src="img/list_icon/ic_user.png"/>&nbsp;&nbsp;&nbsp;Scheduled Call</h1>
                        </div>
                        <div class="block">                  
<form name="callschedule_form" action="SalesStuff" method="post" onsubmit="return validation();">
...
<hr />             
								...
								<tr><td colspan="3">
                            					...
                            					<input type="text" name="summary" style="width:400px; height: 30px;" placeholder="Call Summary"/></td>
                            				</tr>
								<tr>
									<td>
										<table id="tbl2" style="border-spacing: 100px 100px;" cellpadding="10" cellspacing="10">
											 ...
											 <tr>
               										...
               										<td>Date</td><td><input type="text" name="date_name" id="bdate_id" /></td><td></td>
                            						</tr>
					...
					<td>
						...
						%>
							<option value=<%=cat_list.get(i).getCategory_id() %>><%=cat_list.get(i).getCategory_name() %></option>
						<%} %>
						</select></td>
				</tr>
						<tr>
								...
								<tr>
									<td colspan="3"><textarea style="width: 95% !important;" rows="5" name="description" placeholder="Description"></textarea><input type="hidden" name="hid_val" value="scheduled_call"/></td>
